                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('add') }}" method="POST" style="display:inline;">
                                ...
                                <button style="background-color:rgb(0, 0, 0); color:rgb(255, 255, 255); border-radius: 10px; padding: 10px; border: 1px solid #000; cursor: pointer;" type="submit">Sepete Ekle</button>
                            </form>
                        </td>
                    </tr>
                @endforeach
